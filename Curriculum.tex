...
\begin{tabular}{r|p{12cm}}
	\education{Current}
		...
		{
			\normalsize \textsc{Gpa}: 27.5/30 \hyperlink{mrds} {\hfill | \footnotesize Detailed List of Exams}
		}
...
\begin{tabular}{rl}
 Advanced Knowledge:& C++, Java, Rust, Python \\
 Intermediate Knowledge:& \textsc{php}, JavaScript, my\textsc{sql} \\
...
Big Data Computing	&TBD& 6\\
Deep Learning	&TBD&	6\\	\\

Functional Languages	&30& 6\\
Languages for Global Computing &23&6\\
Formal Methods for Cyber-physical Systems & TBD & 6\\ \\
...
Other knowledge & Eligible & 6 \\
Stage	& \textsc{TBD}	& 11 \\
Final Exam	& \textsc{TBD}	& 33 \\	
		\cline{2-3}
	&\textsc{Gpa: } \textbf{27.89} & 120 \\
\end{tabular}
\end{center}
